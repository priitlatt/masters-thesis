...
\begin{proof}
    ...
    tähele, et
    \begin{align*}
        [f \circ g, h] &= -(-1)^{|f \circ g||h|} [h, f \circ g] = \\
        &= -(-1)^{|f \circ g||h|} \left(
...
\begin{lemma}
    Juhul $n = 3$ saab valemis \eqref{naide:end-v-kommutaator}
    esitatud kommutaatori avaldada binaarsete kommutaatorite abil
    järgmiselt:
    \begin{align}
        \begin{split}
        [\phi_1, \phi_2, \phi_3] =\ &\phi_1 \circ [\phi_2, \phi_3] - \\
...
\begin{proof}
    Olgu $\phi_1, \phi_2, \phi_3 \in \End \V$ ning kasutame samu
    tähistusi nagu teoreemi sõnastuses. Väite tõestamiseks
    piisab vahetust arvutamisest.

    \begin{align*}
        [\phi_1, \phi_2, \phi_3] =&\
        (-1)^{|\phi_{123}|}     \phi_1 \circ \phi_2 \circ \phi_3 +
        (-1)^{1 + |\phi_{132}|} \phi_1 \circ \phi_3 \circ \phi_2 + \\
        &\ (-1)^{1 + |\phi_{213}|} \phi_2 \circ \phi_1 \circ \phi_3 +
        (-1)^{|\phi_{231}|}     \phi_2 \circ \phi_3 \circ \phi_1 + \\
        &\ (-1)^{|\phi_{312}|}     \phi_3 \circ \phi_1 \circ \phi_2 +
