...
\begin{proof}
    ...
    näeme, et ühelt poolt

    \begin{align}\label{eq:lemma-tri-komm-with-bi-1}\begin{split}
        &[\phi_1, \phi_2, \phi_3] = \\
    ...
    \end{split}\end{align}
    ning teisalt
    \begin{align}\label{eq:lemma-tri-komm-with-bi-2}\begin{split}
        &\phi_1 \circ [\phi_2, \phi_3] +
            \phi_2 \circ [\phi_1, \phi_3] +
            \phi_3 \circ [\phi_1, \phi_2] = \\
        &= \phi_1 \circ \left( \phi_2 \circ \phi_3 -
            (-1)^{|\phi_2||\phi_3|} \phi_3 \circ \phi_2 \right) + \\
        &\ \quad \phi_2 \circ \left( \phi_1 \circ \phi_3 -
            (-1)^{|\phi_1||\phi_3|} \phi_3 \circ \phi_1 \right) + \\
        &\ \quad \phi_3 \circ \left( \phi_1 \circ \phi_2 -
            (-1)^{|\phi_1||\phi_2|} \phi_2 \circ \phi_1 \right) = \\
        &= \phi_1 \circ \phi_2 \circ \phi_3 + (-1)^{
            1 + |\phi_2||\phi_3|} \phi_1 \circ \phi_3 \circ \phi_2 + \\
        &\ \quad \phi_2 \circ \phi_1 \circ \phi_3 + (-1)^{
            1+ |\phi_1||\phi_3|} \phi_2 \circ \phi_3 \circ \phi_1 + \\
        &\ \quad \phi_3 \circ \phi_1 \circ \phi_2 + (-1)^{
            1 + |\phi_1||\phi_2|} \phi_3 \circ \phi_2 \circ \phi_1.
    \end{split}\end{align}
    Nüüd piisab vaid paneme tähele, et korrutades võrduste ahela
    \eqref{eq:lemma-tri-komm-with-bi-2} vasaku poole
    viimased kaks liidetavat vastavalt suurustega
    \begin{align*}
        (-1)^{1+|\phi_1||\phi_2|}
        \quad \text{ja} \quad
        (-1)^{|\phi_1||\phi_3| + |\phi_2||\phi_3|},
    \end{align*}
    saame täpselt sama tulemuse nagu valemis
    \eqref{eq:lemma-tri-komm-with-bi-1}, ehk kokkuvõttes kehtib võrdus
    \begin{align*}
        &[\phi_1, \phi_2, \phi_3] =
        \phi_1 \circ [\phi_2, \phi_3] -
