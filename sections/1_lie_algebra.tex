...
\subsection{Maatriksrühmad ja bilineaarvorm}
...
\begin{lau}
    ...
    \begin{enumerate}
        \item $e^0 = I$,
        \item $e^X$ on pööratav ning kehtib
            $\left(e^X\right)^{-1} = e^{X^{-1}}$,
        \item $e^{(\lambda + \mu)X} = e^{\lambda X} e^{\mu X}$ suvaliste
            $\lambda, \mu \in \C$ korral,
        \item $e^X e^{-X} = I$,
        \item kui $XY = YX$, siis $e^{X+Y} = e^X e^Y = e^Y e^X$,
        \item kui $C$ on pööratav, siis $e^{CXC^{-1}} = C e^X C^{-1}$,
        \item $\det e^X = e^{\Tr_V X}$.
    \end{enumerate}
\end{lau}
