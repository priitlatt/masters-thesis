...
% TODO: kirjuta siia natuke peatüki sissejuhatuseks
...
\end{align*}
kus $x, y \in \V_1$ ning $\lambda$ on skalaar. Kui vektorruumid $\V_1$ ja $\V_2$
...
$A^\dag = -A$, kus $A^\dag = \overline{A}^T$. Edasi on lihtne konstrueerida saadud alamrühmade
\emph{spetsiaalsed} analoogid. \emph{Spetsiaalsete komplekssete ortogonaalmaatriksite rühm} on
\begin{align*}
...
vektorruumi $\V$ lineaarteisenduste vektorruum $\End \V$ assotsiatiivne algebra,
